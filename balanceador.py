...
class StatelessLB(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.virtual_ip = "192.168.100.6"
        #self.virtual_ip = "10.0.0.5"
        self.virtual_mac = "A6:63:DD:D7:C0:C8" # Pick something dummy and

        self.servers.append({'ip':"192.168.100.1", 'mac':"00:0C:29:5A:4F:F3"})
        self.servers.append({'ip':"192.168.100.3", 'mac':"00:0C:29:E9:86:AD"})
        #self.servers.append({'ip':"192.168.100.1", 'mac':"00:00:00:00:00:04"})
